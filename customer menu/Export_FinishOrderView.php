...
header("Content-Disposition: attachment; filename=Finish Order Retails.xls");
...
<table class="table table table-striped table-bordered bootstrap-datatable datatable responsive">
    ...
    <tbody>
        ...
        $dataDok = mysql_query("SELECT * FROM tbl_order WHERE status_order='Finish Progress Order' AND status_order='BA' AND user = '$user' ORDER BY id Desc");
        $no = 1;
