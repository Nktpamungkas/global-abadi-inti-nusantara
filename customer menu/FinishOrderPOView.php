...
<head>
    <meta charset="utf-8">
    <title>GAIN Satellite Web Apps | Finish Order PO</title>
            ...
            <div id="content" class="col-lg-10 col-sm-10">
                ...
                <div class="row">
                    <div class="box col-md-12">
                        <a href="?g=Export_FinishOrderPO" class="btn btn-success btn-sm" target="BLANK">Export To Excel</a>
                    </div>
                            ...
                            <div class="box-content">
                                <table class="table table table-striped table-bordered bootstrap-datatable datatable responsive">
                                    ...
                                    <tbody>
                                        ...
                                        $dataDok = mysql_query("SELECT * FROM tbl_order_po WHERE status_order='Finish Progress Order' AND user = '$user' ORDER BY id Desc");
                                        $no = 1;
