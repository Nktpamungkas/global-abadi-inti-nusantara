...
<head>
    <meta charset="utf-8">
    <title>GAIN Satellite Web Apps | Laporan Hasil Kerja</title>
            ...
            <div id="content" class="col-lg-10 col-sm-10">
                ...
                <div class="row">
                    <div class="box col-md-12">
                        <a href="?g=Export_LapHasilKerja" class="btn btn-success btn-sm" target="BLANK">Export To Excel</a>
                    </div>
                    <div class="box col-md-12">
                        <div class="box-inner">
                            <div class="box-header well">
                                <h2>Laporan Hasil Kerja Retails</h2>
                                <div class="box-icon">
                            ...
                            <div class="box-content">
                                <table class="table table table-striped table-bordered bootstrap-datatable datatable responsive">
                                    ...
                                    <tbody>
                                        ...
                                        $dataDok = mysql_query("SELECT hasil_kerja.id, hasil_kerja.order_id, hasil_kerja.lokasi, hasil_kerja.tgl_pekerjaan, hasil_kerja.teknisi, hasil_kerja.keterangan_pekerjaan FROM hasil_kerja, tbl_order WHERE tbl_order.user = '$user' ORDER BY id ASC");
                                        $no = 1;
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="?g=PrintHasilKerja&id=<?php echo $fetchDataDok['id']; ?>" Target="_BLANK">
