...
<?php
    if(isset($_POST['submit'])){
        ...
        $save = mysql_query("INSERT INTO area(area,description)VALUES('$area','$description')")or die(mysql_error());
        if($save) {
                ...
                <div class="box col-md-12">
                    <div class="box-inner">
                        <div class="box-header well">
                             <h2><i class="glyphicon glyphicon-file"></i> New Area/Location</h2>
                            <div class="box-icon">
                        ...
                        <div class="box-content">
                            <div class="form-group has-success">
                                <label class="control-label">Name Area/Location</label>
                                <input type="text" class="form-control input-sm" name="area" required>
                            </div>
                            <div class="form-group has-success">
                    ...
                    <div class="box-content">
                        <table class="table table table-striped table-bordered bootstrap-datatable datatable responsive">
                            ...
                            <tbody>
                                    <?php
                                        include_once 'database/connection.php';
                                        $dataDok = mysql_query("SELECT * FROM area");
                                        $no = 1;
                                        while ($fetchDataDok = mysql_fetch_array($dataDok)){
                                    ?>
                                        <tr>
                                            <td><?php echo $no++; ?></td>
                                            <td><?php echo $fetchDataDok['area']; ?></td>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                                ...
                                <div class="modal-body">
                                        <?php
                                            $id = $fetchDataDok['id']; 
                                            $query_edit = mysql_query("SELECT * FROM area WHERE id='$id'");
                                            while ($row = mysql_fetch_array($query_edit)) {  
                                        ?>
                                        <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                                        <p>
                                            <label class="control-label">Name Area</label>
                                            <input type="text" class="form-control input-sm" name="area" value="<?php echo $row['area']; ?>" required>
                                        </p>
                                        <p>
                                            <label class="control-label">Description</label>
