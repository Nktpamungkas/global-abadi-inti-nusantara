                        ...
                        <table class="table table table-striped table-bordered bootstrap-datatable datatable responsive">
                            ...
                            <tbody>
                                <?php
                                    include_once 'database/connection.php';
                                    $statusorder = ' ';
                                    $dataDok = mysql_query("SELECT * FROM kuitansi_invoice_rembust");
                                    while ($fetchDataDok = mysql_fetch_array($dataDok)){
                                ?>
                                    <tr>
                                        <td><?php echo $fetchDataDok['no_kuitansi']; ?></td>
                                        <td>
                                            <a href="?g=EditKuitansiRR&id=<?php echo $fetchDataDok['id']; ?>" class="label label-success">
                                                <span>Edit</span>
                                            </a>&nbsp;
                                            <a href="?g=PrintKuitansiRR&id=<?php echo $fetchDataDok['id']; ?>" class="label label-primary" target="BLANK">
                                                <span>Print</span>
                                            </a>
                                        </td>
                                    </tr>
