...
<?php
    if(isset($_SESSION['userId'])){
        ...
        if(isset($_POST['submit'])){
            ...
            $id_value = '';
            $valueorder = '';
            $update = mysql_query("UPDATE invoice SET date_invoice = '$dateInvoice',
                                                customer_to = '$cusTo',
            ...
            if ($order != null) { // jika ada yang di ceklis
                ...
                $updateRembust = mysql_query("UPDATE rembust SET invoice_rembust='$invoice' WHERE id_order IN"."(".$valueorder.")")or die(mysql_error());
                // untuk mengubah status pada tbl_order karena telah di invoice'kan

                $updateOrder = mysql_query("UPDATE tbl_order SET status_invoice='$invoice' WHERE id IN"."(".$valueorder.")")or die(mysql_error());
...
<head>
    <meta charset="utf-8">
    <title>GAIN Satellite Web Apps | Edit Invoice</title>
            ...
            <div class="box col-md-12">
                <div class="box-inner">
                    <div class="box-header well">
                         <h2><i class="glyphicon glyphicon-file"></i> Edit Invoice</h2>
                        <div class="box-icon">
                        ...
                        <table class="table table table-striped table-bordered bootstrap-datatable datatable responsive">
                            ...
                            <tbody>
                                ...
                                <?php
                                    ...
                                    $dataDok = mysql_query("SELECT * FROM tbl_order WHERE status_invoice = '$statusorder' OR status_invoice = ' ' AND pelunasan = 'LUNAS' ORDER BY id ASC");
