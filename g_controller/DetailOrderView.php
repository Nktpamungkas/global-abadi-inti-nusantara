...
if (isset($_SESSION['userId'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $updateOrder = mysql_query("UPDATE tbl_order SET site = '$site',
                                                        start_progress = '$startprogres',
                                                        teknisi = '$teknisi',
                                                        dana_kontrak = '$DanaKontrak2'
            ...
            <div id="content" class="col-lg-10 col-sm-10">
                ...
                <div>
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="?g=Order">Show/Edit Order</a>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="box col-md-12">
                        <div class="box-inner">
                            <div class="box-header well" data-original-title="">
                                <h2><i class="glyphicon glyphicon-shopping-cart"></i> Order : <?php echo $fetchDataDok['order_id'] . $fetchDataDok['noUrut']; ?></h2>
                                <div class="box-icon">
                            ...
                            <div class="box-content">
                                <form role="form" action="" method="post">
                                    <div class="form-group has-success">
                                        <label class="control-label">Retails / PO</label>
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        <input type="text" class="form-control input-sm" name="site" value="<?php echo $fetchDataDok['site']; ?>" required>
                                    </div>
                                    <div class="form-group has-success">
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        <select name='teknisi' class='form-control input-sm' required>
                                            <?php
                                            include_once 'database/connection.php';
                                            $tknisi = $fetchDataDok['teknisi'];

                                            $tampil = mysql_query("SELECT teknisi FROM teknisi");
                                            while ($w = mysql_fetch_array($tampil)) {
                                                ?>
                                            <option value="<?= $w['teknisi']; ?>" <?php
                                                                                    if ($w['teknisi'] == $tknisi) {
                                                                                        echo "SELECTED";
                                                                                    }
                                                                                    ?>>
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        <input type="date" class="form-control input-sm" name="startprogres" value="<?php echo $fetchDataDok['start_progress']; ?>" required>
                                    </div>
                                    <div class="form-group has-success">
