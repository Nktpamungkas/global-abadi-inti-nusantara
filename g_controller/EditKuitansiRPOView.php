...
<?php
    include_once 'database/connection.php';
    $id = $_GET['id'];
    $dataDok = mysql_query("SELECT * FROM kuitansi_invoice_po_rembust WHERE id='$id'");
...
if(isset($_POST['submit'])){
    ...
    $id_invoice_po_rembust = $_POST['id_invoice_po_rembust'];
    $pembayaran = $_POST['pembayaran'];

    $updateKuitansi = mysql_query("UPDATE kuitansi_invoice_po_rembust SET pembayaran = '$pembayaran' WHERE id = '$id_invoice_po_rembust'");
    if ($updateKuitansi) {
        echo "<script>window.location.href = '/?g=KwitansiRPO';</script>";
    } else {
        ...
        <div class="box-inner">
            ...
            <div class="box-content">
                <form role="form" action="" method="POST">
                    <input type="label" name="id_invoice_po_rembust" value="<?= $fetchDataDok['id']; ?>" hidden>
                    ...
                    <a href="?g=KwitansiPO" class="btn btn-default">Kembali</a> 
                </form>                   
            </div>
        </div>
    </div>
