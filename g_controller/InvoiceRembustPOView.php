...
<head>
    <meta charset="utf-8">
    <title>GAIN Satellite Web Apps | Invoice Rembust PO</title>
                        ...
                        <table class="table table table-striped table-bordered bootstrap-datatable datatable responsive">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $dataDok = mysql_query("SELECT REPLACE(invoice_rembust,'INV','KUI') AS kuitansi,id,invoice_rembust,date_invoice,customer_to,vat,grand_total,status_kuitansi FROM invoice_rembust_po WHERE terbayar = ' ' ORDER BY id ASC");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                        ...
                                                        <div class="modal-dialog modal-sm">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <a href="?g=PrintInvoiceRembustPO&invoice_rembust=<?php echo $fetchDataDok['id']; ?>" class="btn btn-success btn-sm" target="BLANK">Ya</a>

                                                                    <a href="?g=PrintInvoiceRembustPONotLogo&invoice_rembust=<?php echo $fetchDataDok['id']; ?>" class="btn btn-default btn-sm" target="BLANK">Tidak</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
                                                ...
                                                ?>
                                                <?php } else { ?>
                                                    <a href="#" data-toggle="modal" data-target="#KuitansiRPO<?php echo $fetchDataDok['id']; ?>" class="label label-info" target="BLANK">
                                                        <span>Buat Kuitansi</span>
                                                    </a>
                                                <?php } ?>
                                                <!-- Modal Kuitansi Rembust-->
                                                <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" id="KuitansiRPO<?php echo $fetchDataDok['id']; ?>" role="dialog">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">   
                                                                    <div class="form-group has-success">
                                                                        ...
                                                                        <input type="hidden" name="id_invoice_rembust_po" value="<?php echo $fetchDataDok['id']; ?>">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <button type="submit" class="btn btn-success" name="submitRPO">New Kuitansi</button>
                                                ...
                                                <a href="#" data-toggle="modal" data-target="#myModal<?php echo $fetchDataDok['id']; ?>">
                                                    <span class="label label-success">Input Terbayar</span>
                                                </a>
                                            </td>
                                        </tr>
                <!-- Modal -->
                <div class="modal fade" id="myModal<?php echo $fetchDataDok['id']; ?>" role="dialog">
                <form role="form" action="?g=ProsesInvoiceRembustTerbayarPO" method="POST">
                    <div class="modal-dialog">
                        <div class="modal-content">
                                <?php
                                    $id = $fetchDataDok['id']; 
                                    $query_edit = mysql_query("SELECT * FROM invoice_rembust_po WHERE id='$id'");
