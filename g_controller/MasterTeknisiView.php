...
<?php
    if(isset($_POST['submit'])){
        ...
        $save = mysql_query("INSERT INTO teknisi(teknisi)VALUES('$teknisi')")or die(mysql_error());
        if($save) {
    ...
    <div class="row">
        ...
        <div id="content" class="col-lg-10 col-sm-10">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="?g=MasterTeknisi">Teknisi</a>
                </li>
            </ul>
        </div>
                ...
                <div class="box col-md-12">
                    <div class="box-inner">
                        <div class="box-header well">
                             <h2><i class="glyphicon glyphicon-file"></i> New Teknisi</h2>
                            <div class="box-icon">
                        ...
                        <div class="box-content">
                            <div class="form-group has-success">
                                ...
                                <input type="text" class="form-control input-sm" name="teknisi" required>
                            </div>
                    ...
                    <div class="box-content">
                        <table class="table table table-striped table-bordered bootstrap-datatable datatable responsive">
                            ...
                            <tbody>
                                    <?php
                                        include_once 'database/connection.php';
                                        $dataDok = mysql_query("SELECT * FROM teknisi");
                                        $no = 1;
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                                ...
                                <div class="modal-body">
                                        <?php
                                            $id = $fetchDataDok['id']; 
                                            $query_edit = mysql_query("SELECT * FROM teknisi WHERE id='$id'");
                                            while ($row = mysql_fetch_array($query_edit)) {  
                                        ?>
                                        <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                                        <p>
                                            <label class="control-label">Name Teknisi</label>
                                            <input type="text" class="form-control input-sm" name="teknisi" value="<?php echo $row['teknisi']; ?>" required>
                                        </p>
                                        <p>
                                            <label class="control-label">Handphone</label>
                                            <input type="text" class="form-control input-sm" name="no_hp" value="<?php echo $row['no_hp']; ?>" required>
                                        </p>
                                </div>
