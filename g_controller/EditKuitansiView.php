...
<?php
    include_once 'database/connection.php';
    $id = $_GET['id'];
    $dataDok = mysql_query("SELECT * FROM kuitansi_invoice WHERE id='$id'");
...
if(isset($_POST['submit'])){
    ...
    $updateKuitansi = mysql_query("UPDATE kuitansi_invoice SET pembayaran = '$pembayaran' WHERE id = '$id_invoice'");
    if ($updateKuitansi) {
        echo "<script>window.location.href = '/?g=KwitansiR';</script>";
    } else {
        ...
        <div class="box-inner">
            ...
            <div class="box-content">
                <form role="form" action="" method="POST">
                    ...
                    <a href="?g=KwitansiR" class="btn btn-default">Kembali</a> 
                </form>                   
            </div>
        </div>
    </div>
