...
<?php
    ...
    if ($bank == "BRI") {
        ...
        $query = mysql_query("UPDATE invoice_rembust SET tgl_terbayar = '$tgl_terbayar', terbayar = 'Lunas' WHERE id = '$id'");

    if ($query AND $queryBank) {
        echo "<script>window.location.href = '/?g=invoiceRembustTerbayar';</script>";	
    }else{
