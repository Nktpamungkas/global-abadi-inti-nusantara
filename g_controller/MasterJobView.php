...
<?php
    if(isset($_POST['submit'])){
        ...
        $save = mysql_query("INSERT INTO job(job,description)VALUES('$job','$description')")or die(mysql_error());
        if($save) {
...
<head>
    <meta charset="utf-8">
    <title>GAIN Satellite Web Apps | File Job</title>
                ...
                <div class="box col-md-12">
                    <div class="box-inner">
                        <div class="box-header well">
                             <h2><i class="glyphicon glyphicon-file"></i> New Job</h2>
                            <div class="box-icon">
                        ...
                        <div class="box-content">
                            <div class="form-group has-success">
                                ...
                                <input type="text" class="form-control input-sm" name="job" required>
                            </div>
                            <div class="form-group has-success">
                    ...
                    <div class="box-content">
                        <table class="table table table-striped table-bordered bootstrap-datatable datatable responsive">
                            ...
                            <tbody>
                                    <?php
                                        include_once 'database/connection.php';
                                        $dataDok = mysql_query("SELECT * FROM job");
                                        $no = 1;
                                        while ($fetchDataDok = mysql_fetch_array($dataDok)){
                                    ?>
                                        <tr>
                                            <td><?php echo $no++; ?></td>
                                            <td><?php echo $fetchDataDok['job']; ?></td>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                                ...
                                <div class="modal-body">
                                        <?php
                                            $id = $fetchDataDok['id']; 
                                            $query_edit = mysql_query("SELECT * FROM job WHERE id='$id'");
                                            while ($row = mysql_fetch_array($query_edit)) {  
                                        ?>
                                        <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                                        <p>
                                            <label class="control-label">Name Job</label>
                                            <input type="text" class="form-control input-sm" name="job" value="<?php echo $row['job']; ?>" required>
                                        </p>
                                        <p>
                                            <label class="control-label">Description</label>
