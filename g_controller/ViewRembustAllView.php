...
include_once 'database/connection.php';
$id = $_GET['id'];
$dataDRembust = mysql_query("SELECT sum(Dana_Rembust) AS Dana_Rembust FROM rembust WHERE id_order='$id' AND SUBSTR(Order_ID,1,1) = 'R'");
        ...
        <div class="col-sm-4">
            <table class="table bootstrap-datatable table-striped">
                ...
                <tbody>
                    ...
                    $dataDok = mysql_query("SELECT * FROM rembust WHERE id_order = '$id' AND SUBSTR(Order_ID,1,1) = 'R' ORDER BY id ASC");
