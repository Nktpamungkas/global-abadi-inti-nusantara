    ...
    if (isset($_POST['submit'])) {
        ...
        if ($dk == "D") {
            $saveFolder = mysql_query("INSERT INTO kaskecil(account,tgl,kas,debit,kredit,keterangan) 
                        VALUES('$account','$tgl','KK 1','$nominal2','0','$keterangan')");
            if ($saveFolder) {
                echo "<script>window.location.href = '/?g=Keuangan_KasKecil1';</script>";
            } else {
                echo "QUERY DEBIT ERROR";
            }
        } else {
            $saveFolder = mysql_query("INSERT INTO kaskecil(account,tgl,kas,debit,kredit,keterangan) 
                        VALUES('$account','$tgl','KK 1','0','$nominal2','$keterangan')");
            if ($saveFolder) {
                echo "<script>window.location.href = '/?g=Keuangan_KasKecil1';</script>";
            } else {
        ...
        <div class="row">
            ...
            <div id="content" class="col-lg-10 col-sm-10">
                ...
                <div class="row">
                            ...
                            <div class="box-content">
                                <form action="" method="post">
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        $tampil = mysql_query("SELECT * FROM account_kasbank WHERE bank = 'KK1' ORDER BY id");
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        <input type="text" class="form-control input-sm uang" name="nominal">
                                    </div>
                                    <div class="form-group has-success">
                    ...
                    <div class="box col-md-12">
                        <a href="?g=Export_KK1" class="btn btn-success btn-sm" target="BLANK">Export To Excel</a>
                    </div>
                            ...
                            <div class="box-content">
                                <table class="table table table-striped table-bordered bootstrap-datatable datatable responsive">
                                    ...
                                    <tbody>
                                        <?php
                                        include_once 'database/connection.php';
                                        $dataDok = mysql_query("SELECT * from kaskecil WHERE kas = 'KK 1' ORDER BY id ASC");
                                        $no = 1;
