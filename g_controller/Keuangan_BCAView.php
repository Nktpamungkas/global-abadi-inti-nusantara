...
if (isset($_SESSION['userId'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($dk == "D") {
            $saveFolder = mysql_query("INSERT INTO kasbank(account,bank,tgl,debit,kredit,keterangan) VALUES('$account','BCA','$tgl','$nominal2','0','$keterangan')");
                
            if($saveFolder) {
                echo "<script>window.location.href = '/?g=Keuangan_BCA';</script>";
            } else {
                echo "QUERY ERROR DEBIT";
            }
        }elseif ($dk == "K") {
            $saveFolder = mysql_query("INSERT INTO kasbank(account,bank,tgl,debit,kredit,keterangan) VALUES('$account','BCA','$tgl','0','$nominal2','$keterangan')");
            ...
            VALUES('$idkasbank','$account','BCA','$keterangan','$tgl','$nominal2','0','BCA')");
...
<head>
    <meta charset="utf-8">
    <title>GAIN Satellite Web Apps | Kas BCA</title>
...
<div id="content" class="col-lg-10 col-sm-10">
    ...
    <div>
        <ul class="breadcrumb">
            ...
            <li>
                <a href="?g=Keuangan_BCA">Kas BCA</a>
            </li>
        </ul>
    </div>
        ...
        <div class="row">
                            ...
                            <div class="form-group has-success">
                                ...
                                <?php
                                    include_once 'database/connection.php';
                                        ...
                                        $tampil=mysql_query("SELECT * FROM account_kasbank WHERE bank = 'BCA' ORDER BY id");
            ...
            <div class="box col-md-12">
                <a href="?g=Export_BCA" class="btn btn-success btn-sm" target="BLANK">Export To Excel</a>
            </div>
                    ...
                    <div class="box-content">
                        <table class="table table table-striped table-bordered bootstrap-datatable datatable responsive">
                            ...
                            <tbody>
                                <?php
                                include_once 'database/connection.php';
                                $dataDok = mysql_query("SELECT * from kasbank WHERE bank='BCA' ORDER BY id ASC");
                                $no = 1;
