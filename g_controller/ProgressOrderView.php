    ...
    <div class="row">
        ...
        <div class="row">
            <div class="box col-md-12">
                <a href="?g=Export_ProgressOrder" class="btn btn-success btn-sm" target="BLANK">Export To Excel</a>
            </div>
                    ...
                    <div class="box-content">
                        <table class="table table table-striped table-bordered bootstrap-datatable datatable responsive">
                            ...
                            <tbody>
                                <?php
                                    include_once 'database/connection.php';
                                    $dataDok = mysql_query("SELECT * FROM tbl_order WHERE status_order = 'Progress Order' ORDER BY id DESC");
                                    $no = 1;
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <?php if ($fetchDataUserBySesion['jabatan'] == "SA" || $fetchDataUserBySesion['jabatan'] == "MO" || $fetchDataUserBySesion['jabatan'] == "AO") { ?>
                                            <td>
                                                <a href="?g=DetailOrder&id=<?php echo $fetchDataDok['id']; ?>">
                                                    <span class="label-primary label label-primary" title="Edit">Show/Edit</span></a>

                                                <a href="?g=EditOrder&id=<?php echo $fetchDataDok['id']; ?>">
                                                    <span class="label-success label label-default">Req. Dana</span></a>

                                                <a href="?g=ViewRembustAll&id=<?php echo $fetchDataDok['id']; ?>" target="_BLANK">
                                                    <span class="label-success label label-warning" title="Print Rembust">View</span></a>

                                                <a href="?g=StopProgressOrder&id=<?php echo $fetchDataDok['id']; ?>">
                                                    <span class="label-default label label-danger" title="Finish Order">Finish</span></a>
                                            </td>
                                        <?php } ?>
                                    </tr>
                                    <!-- Modal -->
                                    <div class="modal fade" id="myModal<?php echo $fetchDataDok['id']; ?>" role="dialog">
                                        <form role="form" action="?g=DeleteProgressOrder" method="POST">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <?php
                                                        $id = $fetchDataDok['id']; 
                                                        $query_edit = mysql_query("SELECT * FROM tbl_order WHERE id='$id'");
