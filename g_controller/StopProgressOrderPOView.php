...
<?php
    include_once 'database/connection.php';
    $order_id = $_GET['id'];
    $dataDok = mysql_query("SELECT * FROM tbl_order_po WHERE id='$order_id'");
...
if(isset($_POST['submit'])){
    ...
    //
    $saveFolder = mysql_query("UPDATE tbl_order_po SET stop_progress = '$stopprogress', status_order = 'Finish Progress Order', opsi = 'Hasil Kerja' WHERE id = '$id'");
    if($saveFolder) {
    ...
    <div class="box col-md-9">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i> Progress Order PO</h2>
            </div>
            <div class="box-content">
                <form role="form" action="" method="POST">
                    ...
                    <div class="form-group has-success">
                        ...
                        <input type="date" class="form-control input-sm" name="stopprogress">
                    </div>
