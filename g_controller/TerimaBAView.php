...
if(isset($_POST['submit'])){
    ...
    $cektglba = "SELECT tgl_ba_terima FROM tbl_order WHERE id='$id'";
    $hasilcek = mysql_query($cektglba);
    $datacek = mysql_fetch_array($hasilcek);
    $data = $datacek['tgl_ba_terima'];

    if ($data == null) {
        $saveFolder = mysql_query("INSERT INTO finish_order_ba(order_id,tgl_terima_ba) VALUES('$id','$tglbaditerima')");
        $updateTblOrder = mysql_query("UPDATE tbl_order SET tgl_ba_terima='$tglbaditerima' WHERE id='$id'");
        if($saveFolder) {
    ...
    if ($data == null) {
        ...
        $updateOrder = mysql_query("UPDATE tbl_order SET tgl_ba_terima='$tglbaditerima' WHERE id='$id'");
        $updateFinishOrder = mysql_query("UPDATE finish_order_ba SET tgl_terima_ba = '$tglbaditerima' WHERE order_id='$id'");
