...
<?php
    include_once 'database/connection.php';
    $id = $_GET['id'];
    $dataDok = mysql_query("SELECT * FROM kuitansi_invoice_po WHERE id='$id'");
...
if(isset($_POST['submit'])){
    ...
    $updateKuitansi = mysql_query("UPDATE kuitansi_invoice_po SET pembayaran = '$pembayaran' WHERE id = '$id_invoice_po'");
    if ($updateKuitansi) {
        echo "<script>window.location.href = '/?g=KwitansiPO';</script>";
    } else {
        ...
        <div class="box-inner">
            ...
            <div class="box-content">
                <form role="form" action="" method="POST">
                    <input type="label" name="id_invoice_po" value="<?= $fetchDataDok['id']; ?>" hidden>
