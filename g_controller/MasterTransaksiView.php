...
<?php
    if(isset($_POST['submit'])){
        ...
        $save2 = mysql_query("INSERT INTO transaksi(transaksi,kode)VALUES('$transaksi','$kode')")or die(mysql_error());
        if($save2) {
    ...
    <div class="row">
        ...
        <div id="content" class="col-lg-10 col-sm-10">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="?g=MasterUser">Account Transaksi</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
                ...
                <div class="box col-md-12">
                    <div class="box-inner">
                        <div class="box-header well">
                             <h2><i class="glyphicon glyphicon-file"></i> New Account Transaksi</h2>
                            <div class="box-icon">
                        ...
                        <div class="box-content">
                            <div class="form-group has-success">
                                ...
                                <input type="text" class="form-control input-sm" name="transaksi" required>
                            </div>
                            <div class="form-group has-success">
            ...
            <div class="box col-md-12">
                    ...
                    <div class="box-content">
                        <table class="table table table-striped table-bordered bootstrap-datatable datatable responsive">
                            ...
                            <tbody>
                                    <?php
                                        include_once 'database/connection.php';
                                        $dataDok = mysql_query("SELECT * FROM transaksi");
                                        $no = 1;
                                        while ($fetchDataDok = mysql_fetch_array($dataDok)){
                                    ?>
                                        <tr>
                                            <td><?php echo $no++; ?></td>
                                            <td><?php echo $fetchDataDok['transaksi']; ?></td>
                ...
                <form role="form" action="?g=EditMasterTransaksi" method="POST">
                    <div class="modal-dialog">
                        <div class="modal-content">
                                ...
                                <div class="modal-body">
                                        <?php
                                            $id = $fetchDataDok['id']; 
                                            $query_edit = mysql_query("SELECT * FROM transaksi WHERE id='$id'");
                                            while ($row = mysql_fetch_array($query_edit)) {  
                                        ?>
                                        <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                                        <p>
                                            <label class="control-label">Transaksi</label>
                                            <input type="text" class="form-control input-sm" name="transaksi" value="<?php echo $row['transaksi']; ?>" required>
                                        </p>
                                        <p>
                                            <label class="control-label">Kode</label>
                                            <input type="text" class="form-control input-sm" name="kode" value="<?php echo $row['kode']; ?>">
                                        </p>
                                </div>
