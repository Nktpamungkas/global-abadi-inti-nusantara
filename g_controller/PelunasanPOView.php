...
include_once 'database/connection.php';
$id = $_GET['id'];
$dataDokpelunasan = mysql_query("SELECT * FROM pelunasan_po WHERE Order_ID='$id'");
...
if (isset($_POST['submit'])) {
    ...
    $saveRembust = mysql_query("INSERT INTO pelunasan_po (Order_ID,tgl_pelunasan,nominal,deskripsi,rekening) 
                                                VALUES ('$id','$tglPelunasan','$nominal2','$deskripsi','$rekening')");

    // Save To Kas Kecil
    $query = "SELECT * FROM pelunasan_po WHERE Order_ID = '$id'";
    ...
    $updateLunas = mysql_query("UPDATE tbl_order_po SET pelunasan = 'LUNAS', hasil_kerja = 'Done' WHERE id = '$id'");
    ...
    if ($rekening != "KK 1" and $rekening != "KK 2") {
        ...
        $saveRembust = mysql_query("UPDATE pelunasan_po SET Order_ID='$id',
        ...
        $updatetoKas = mysql_query("UPDATE kaskecil SET kas = '$rekening',
                                                        ...
                                                        AND substr(uraian,1,2) = 'PO'");

        $updateLunas = mysql_query("UPDATE tbl_order_po SET pelunasan = 'LUNAS', 
                                                            hasil_kerja = 'Done' WHERE id = '$id'");
        if ($saveRembust and $updatetoKas and $updateLunas) {
            echo "<script>window.location.href = '/?g=FinishOrderPO';</script>";
            $pesanError = 'Pelunasan berhasil diubah, silahkan kembali.';
        } else {
...
<head>
    <meta charset="utf-8">
    <title>GAIN Satellite Web Apps | Pelunasan PO</title>
        ...
        <div class="row">
            ...
            <div id="content" class="col-lg-10 col-sm-10">
                ...
                <div>
                    <ul class="breadcrumb">
                        <li>
                            <a href="?g=Order">Order PO</a>
                        </li>
                        <li>
                            <a href="#">Pelunasan PO</a>
                        </li>
                    </ul>
                </div>
