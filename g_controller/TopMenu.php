...
if (isset($_POST['submit'])) {
    ...
    $q_logout = mysql_query("UPDATE staff SET `status` = 'Log out', class = 'label-default label label-danger', logout_date = '$dateLogout' WHERE id_staff = '$fetchDataUserBySesion[id_staff]' ");
    if ($q_logout) {
        ...
        <ul class="collapse navbar-collapse nav navbar-nav top-menu">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                    ...
                    <li><a href="?g=MasterUsers">Staff</a></li>
                </ul>
            </li>
        </ul>
        <?php 
