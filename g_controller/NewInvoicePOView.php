...
if (isset($_POST['submit'])) {
    ...
    $id_value = '';
    $valueorder = '';
    $save = mysql_query("INSERT INTO invoice_po(invoice,invoice_number,date_invoice,customer_to,address_customer,payment_to,bank,address_payment,aproved_by,position,vat,nomor_inv_po) 
    VALUES('$invoice','$hasilkode','$dateInvoice','$cusTo','$addressCustomer','$payment','$nameBank','$AddressPayment','$approved','$position','$nilaivat','$nomorpo')");
            ...
            <div id="content" class="col-lg-10 col-sm-10">
                ...
                <div>
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="?g=invoicePO">Invoice PO</a>
                        </li>
                    </ul>
                </div>
                        ...
                        <div class="box col-md-12">
                            <div class="box-inner">
                                ...
                                <div class="box-header well">
                                    <h2><i class="glyphicon glyphicon-file"></i> New Invoice PO</h2>
                                    <div class="box-icon">
                                ...
                                <input type="text" class="form-control input-sm" name="nilaivat" id="nilaivat"> -->
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        <input type="text" class="form-control input-sm" name="nomorpo" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="box-content">
                                    <table class="table table table-striped table-bordered bootstrap-datatable datatable responsive">
                                        ...
                                        <tbody>
                                            <?php
                                            include_once 'database/connection.php';
                                            $cekData = mysql_query("SELECT *, COUNT(order_id) as totalPO, COUNT(noUrut) as totalNoUrut, COUNT(IF(pelunasan='LUNAS',1, NULL)) 'totalLunas' FROM tbl_order_po where status_invoice = '' GROUP BY order_id, noUrut");
                                            while ($fetchDataDok = mysql_fetch_array($cekData)) :
                                                if($fetchDataDok['totalPO'] != $fetchDataDok['totalLunas'] AND $fetchDataDok['totalNoUrut'] != $fetchDataDok['totalLunas']) :
                                                else :
                                            ?>
                                            <tr>
                                                <td><?= $fetchDataDok['order_id'] . $fetchDataDok['noUrut']; ?></td>
                                                <td><?= $fetchDataDok['start_progress']; ?></td>
                                                <td><?= $fetchDataDok['stop_progress']; ?></td>
                                                <!-- <td class="uang"><?php  ?></td> -->
                                                <td><input type='text' name='dana_rembust[]' class='form-control uang input-sm' value="<?php echo $fetchDataDok['dana_kontrak']; ?>"></td>
                                                <td>
