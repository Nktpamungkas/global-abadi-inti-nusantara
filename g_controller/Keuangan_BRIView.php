...
if (isset($_SESSION['userId'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($dk == "D") {
            $saveFolder = mysql_query("INSERT INTO kasbank(account,bank,tgl,debit,kredit,keterangan) VALUES('$account','BRI','$tgl','$nominal2','0','$keterangan')");
                
            if($saveFolder) {
                echo "<script>window.location.href = '/?g=Keuangan_BRI';</script>";
            } else {
                echo "QUERY ERROR DEBIT";
            }
        }elseif ($dk == "K") {
            $saveFolder = mysql_query("INSERT INTO kasbank(account,bank,tgl,debit,kredit,keterangan) VALUES('$account','BRI','$tgl','0','$nominal2','$keterangan')");
            ...
            $saveToKasKecil = mysql_query("INSERT INTO kasbesar(id_kasbank,account,bank,uraian,tgl,debit,kredit,keterangan) 
                                VALUES('$idkasbank','$account','BRI','$keterangan','$tgl','$nominal2','0','BRI')");
...
<head>
    <meta charset="utf-8">
    <title>GAIN Satellite Web Apps | Kas BRI</title>
...
<div id="content" class="col-lg-10 col-sm-10">
    ...
    <div>
        <ul class="breadcrumb">
            ...
            <li>
                <a href="?g=Keuangan_BRI">Kas BRI</a>
            </li>
        </ul>
    </div>
        ...
        <div class="row">
                            ...
                            <div class="form-group has-success">
                                ...
                                <?php
                                    include_once 'database/connection.php';
                                        ...
                                        $tampil=mysql_query("SELECT * FROM account_kasbank WHERE bank = 'BRI' ORDER BY id");
            ...
            <div class="box col-md-12">
                <a href="?g=Export_BRI" class="btn btn-success btn-sm" target="BLANK">Export To Excel</a>
            </div>
                    ...
                    <div class="box-content">
                        <table class="table table table-striped table-bordered bootstrap-datatable datatable responsive">
                            ...
                            <tbody>
                                <?php
                                include_once 'database/connection.php';
                                $dataDok = mysql_query("SELECT * from kasbank WHERE bank='BRI' ORDER BY id ASC");
                                $no = 1;
