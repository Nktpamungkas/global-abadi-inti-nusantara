...
<?php
    include_once 'database/connection.php';
    $id = $_GET['id'];
    $dataHasilKerja = mysql_query("SELECT * FROM hasil_kerja WHERE id_order='$id'");
...
if(isset($_POST['submit'])){
    ...
    $Update = mysql_query("UPDATE hasil_kerja SET lokasi = '$lokasi',
                                                  teknisi = '$teknisi',
                                                  no_hp = '$NoHp',
