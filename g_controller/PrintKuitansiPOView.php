...
<?php
    include_once 'database/connection.php';
    $id = $_GET['id'];
    $dataDok = mysql_query("SELECT a.id, b.invoice,
                                    b.invoice_number,
                                    a.no_kuitansi,
                                    b.customer_to,
                                    ...
                                    b.position
                                FROM
                                    kuitansi_invoice_po a
                                    LEFT JOIN ( SELECT * FROM invoice_po b ) b ON b.id = a.id_invoice
	...
	<div style="float: right; width: 39%;">
		<table>
			...
			<tr>
				...
				<td><b><?= $fetchDataDok['invoice'].$fetchDataDok['invoice_number'] ?></b></td>
			</tr>
		</table>
	</div>
	<div style="clear: both"></div>
