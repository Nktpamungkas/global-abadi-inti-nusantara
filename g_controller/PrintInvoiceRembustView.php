...
$dataDok = mysql_query("SELECT * FROM invoice_rembust WHERE id = '$invoice_rembust'");
...
<body onload="print();">
    ...
    <div id="page-wrap">
        ...
        <textarea id="header">INVOICE REIMBURSMENT</textarea>
        ...
        <table id="items">
            ...
            <tbody style="font-size: 12px;">
				...
				$dataDok = mysql_query("SELECT * FROM invoice_detail_rembust WHERE invoice_rembust = '$invR' ORDER BY id ASC");
				$no = 1;
                ...
                <tr>
                    ...
                    <td>
						...
						$trim = rtrim($invR, "A");
						$query = mysql_query("SELECT * FROM rembust WHERE invoice_rembust = '$trim'");
            ...
            <tfoot style="font-size: 12px;">
				...
				include_once 'database/connection.php';
				$invR = $fetchDataDok['invoice_rembust'];
				$dataTotal = mysql_query("SELECT sum(dana_rembust) as dana_rembust FROM invoice_detail_rembust WHERE invoice_rembust = '$invR' ORDER BY id ASC");
