    ...
    <div id="page-wrap">
        ...
        <table id="items">
            ...
            <tbody style="font-size: 12px;">
				...
				$dataDok = mysql_query("SELECT * FROM invoice_detail_po WHERE invoice = '$invID' GROUP BY invoice ORDER BY id ASC");
				$no = 1;
            ...
            <tfoot style="font-size: 12px;">
				...
				include_once 'database/connection.php';
				$id = $_GET['id'];
				$dataTotal = mysql_query("SELECT dana_kontrak FROM invoice_detail_po WHERE invoice = '$invID' GROUP BY invoice ORDER BY id ASC");
